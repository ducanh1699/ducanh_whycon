...
void whycon::RobotPosePublisher::mavposeCallback(const geometry_msgs::PoseStamped &msg) {
  ...
  quat = Eigen::Quaternionf(mavAtt_(0),mavAtt_(1),mavAtt_(2),mavAtt_(3));
...
void whycon::RobotPosePublisher::on_poses(const geometry_msgs::PoseArrayConstPtr& pose_array)
{
  ...
  case 2:
    ...
    world_Marker_pose1 = neu2uav_matrix_*uav_Marker_pose1;

    Eigen::Vector3d average_pose;
  ...
  case 3:
    ...
    world_Marker_pose2 = neu2uav_matrix_*uav_Marker_pose2;

    // compare point
    Eigen::Vector3d com1, com2, com3;
    Eigen::Vector3d average_pose;
  ...
  case 4:
    ...
    world_Marker_pose3 = neu2uav_matrix_*uav_Marker_pose3;
    // compare point
    Eigen::Vector3d com1, com2, com3;
    Eigen::Vector3d average_pose;
    com1 = world_Marker_pose - world_Marker_pose1;
